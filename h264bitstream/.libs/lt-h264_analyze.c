...
/* ./.libs/lt-h264_analyze.c - temporary wrapper executable for .libs/h264_analyze
   Generated by libtool (GNU libtool) 2.4.2

   The h264_analyze program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "/cygdrive/c/SunriseSW/Contracting/Cablelabs_MPEGDASH/skit-refsw/h264bitstream/.libs:";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "/cygdrive/c/SunriseSW/Contracting/Cablelabs_MPEGDASH/skit-refsw/h264bitstream/.libs:/usr/local/lib:/usr/local/bin:";
const char * TARGET_PROGRAM_NAME = "h264_analyze"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# h264_analyze - temporary wrapper script for .libs/h264_analyze\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2\n", f);
  fputs ("#\n", f);
  fputs ("# The h264_analyze program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("  notinst_deplibs=' libh264bitstream.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"h264_analyze:h264_analyze:${LINENO}: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"h264_analyze:h264_analyze:${LINENO}: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"h264_analyze:h264_analyze:${LINENO}: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/SunriseSW/Contracting/Cablelabs_MPEGDASH/skit-refsw/h264bi", f);
  fputs ("tstream/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/SunriseSW/Contracting/Cablelabs_MPEGDASH/skit-refsw/h264b", f);
  fputs ("itstream/.libs:$PATH\"\n", f);
  fputs ("\n", f);
